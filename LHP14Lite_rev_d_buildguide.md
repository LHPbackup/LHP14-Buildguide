...
・基板製造メーカー変更により、基板の色調が半つや消しに変わりました。  

・SK6812MINI-E装着時に必要なチップコンデンサをキット付属から外しました。それに伴い頒布価格を下げました。
...
LEDとコンデンサのはんだ付けが終わったら、[ファームを焼いてテスト](./LHP14Lite_d_hardware_test.md/) します。  
